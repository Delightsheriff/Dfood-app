        ...
        >
          ...
          <View className="mb-8">
            ...
            <Text className="text-sm font-body text-text-gray mt-1 leading-5">
              Sign in to sync your favorites, addresses, and track live deliveries across devices.
            </Text>
          </View>
          ...
          <View className="gap-4 mb-6">
            ...
            <View>
              <View className="flex-row justify-between items-center mb-2">
                <Text className="text-xs font-label uppercase tracking-wider text-text-gray">
                  Password
                </Text>
                <Pressable
          ...
          >
            {isLoading ? (
              ...
              <ButtonText className="text-white text-base">Sign In</ButtonText>
            )}
          </Pressable>
